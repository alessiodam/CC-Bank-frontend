...
const transactionFormSchema = z.object({
    ...
    note: z.string()
        .min(1, "Note")
        .max(30, "Note is too long")
        .optional(),
});

export function CreateTransactionForm({ setBalance, fetchTransactions }: { setBalance: (balance: number) => void; fetchTransactions: () => void }) {
    ...
    async function onSubmit(values: z.infer<typeof transactionFormSchema>) {
        ...
        const response = await fetch("https://ccbank.tkbstudios.com/api/v1/transactions/new", {
            ...
            toast.error("An error occurred while creating transaction. Please try again.");
            setProcessing(false);
            console.error(e);
            throw e;
        });
